...
import { Button, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Badge, } from "@/components/ui/index";
    ...
    return (
        <div className="flex lg:flex-col justify-between gap-4">
            ...
            <Select
                ...
                onValueChange={(value) => {
                    setSortBy(value);
                    setTimeout(() => applyFilters(), 0); // Apply filters immediately when sort changes
                }}
            >
                <SelectTrigger className="w-[180px] lg:w-full"><SelectValue placeholder="Sort by" /></SelectTrigger>
                <SelectContent>
                    {[
